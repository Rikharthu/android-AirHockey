...
public class AirHockeyRendererOld implements GLSurfaceView.Renderer {
    public static final String LOG_TAG = AirHockeyRendererOld.class.getSimpleName();
    ...
    public AirHockeyRendererOld(Context context) {
        mContext = context;
    }
